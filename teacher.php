                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                    <div class="pricing-item">
                        ...
                        <div class="pricing-body">
                            ...
                            <ul class="list">
                                <li class="active">Solve Doubts</li>
                                <li class="active">Make Announcements</li>
                                <li class="active">Connect to Students</li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.4s">
                    <div class="pricing-item ">
                        ...
                        <div class="pricing-body">
                            ...
                            <ul class="list">
                                <li class="active">Conduct Lectures</li>
                                <li class="active">Give Presentations</li>
                                <li class="active">Attend meetings</li>
                            </ul>
                        </div>
                        <div class="pricing-footer">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.6s">
                    <div class="pricing-item">
                        ...
                        <div class="pricing-body">
                            ...
                            <ul class="list">
                                <li class="active">Conduct Tests</li>
                                <li class="active">Take Assignments</li>
                                <li class="active">Evaluate Growth</li>

                            </ul>
                        </div>
                        <div class="pricing-footer">
                            <a href="exam/dash.php" class="main-button">Get Started</a>
                        </div>
                    </div>
                </div>
                <!-- ***** Pricing Item End ***** -->
